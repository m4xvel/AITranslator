...
import com.m4xvel.aitranslator.data.repository.ApplicationSettingsRepositoryImpl
...
val domainModule = module {
    ...
    single<ApplicationSettingsRepository> { ApplicationSettingsRepositoryImpl(androidContext()) }
}